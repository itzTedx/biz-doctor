...
type SheetOverlayProps = Omit<React.ComponentProps<typeof SheetPrimitive.Overlay>, "asChild" | "forceMount"> &
  HTMLMotionProps<"div">;

function SheetOverlay({ transition = { duration: 0.2, ease: "easeInOut" }, ...props }: SheetOverlayProps) {
  return (
