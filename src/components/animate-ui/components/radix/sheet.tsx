  ...
  return (
    <SheetPortalPrimitive>
      ...
      <SheetContentPrimitive
        className={cn(
          "!inset-y-2 fixed z-50 flex flex-col gap-4 rounded-xl bg-card shadow-lg",
          side === "right" && "!right-2 top-5 h-[98%] w-[350px] border-l",
...
function SheetTitle({ className, ...props }: SheetTitleProps) {
  return <SheetTitlePrimitive className={cn("font-semibold text-foreground", className)} {...props} />;
}
